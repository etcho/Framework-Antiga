...
function LyteBox() {
	...
	/*** Start String Configuration ***/
		this.hintClose			= "Fechar";	// Shortcut: 'Escape' or 'X' or 'C'
		this.hintPlay			= "Continuar Slide";
		this.hintPause			= "Pausar Slide";
		this.hintNext			= "Próxima imagem. \n";	// Shortcut: 'Right Arrow' or 'N'
		this.hintPrev			= "Imagem anterior. \n";	// Shortcut: 'Left Arrow' or 'P'
		this.hintSave			= "Use este botão para abrir a imagem atual";
		this.hintResize			= "Redimensiona a imagem para melhor visualização ou restaurar seu tamanho original";		// Shortcut: 'R' or 'S'
		this.hintInfo			= "Exibir informações adicionais sobre a imagem";	// Shortcut: 'I'
		this.hintExif			= "Exibir informação EXIF desta imagem";	// Shortcut: 'E'
		this.hintBack			= "Retornar para a imagem";	// Shortcut: 'Left Arrow' or 'P'
		this.hintEasySave		= "Para salvar a imagem, clique com o botão direito e selecione Salvar Link Como";
		this.hintClickToClose	= "Fechar. \n";
		this.textImageNum		= "Imagem %1 de %2"; // %1 - current, %2 - total
		this.textPageNum		= "Página %1 de %2";	// %1 - current, %2 - total
		this.textNavPrev		= "&laquo; ANT";	// &laquo; prev
		this.textNavNext		= "PROX &raquo;";	// next &raquo;
